...
(defconst feature-mode-keywords
  '("Feature" "Scenario", "Given", "Then", "When", "And", "Szenario","Gegeben sei", "Und", "Dann", "Wenn"))
...
(defconst feature-font-lock-keywords
  (list
   ...
   '("^ *Funktionalität:" (0 font-lock-keyword-face) (".*" nil nil (0 font-lock-type-face t)))
   '("^ *Szenario\\(?: Outline\\)?:" (0 font-lock-keyword-face) (".*" nil nil (0 font-lock-function-name-face t)))
   '("^ *Gegeben sei" . font-lock-keyword-face)
   '("^ *Wenn" . font-lock-keyword-face)
   '("^ *Dann" . font-lock-keyword-face)
   '("^ *Und" . font-lock-keyword-face)
   '("^ *\\(?:Mehr \\)?Beispiele:" . font-lock-keyword-face)
